...
AppType sniToAppType(const std::string& sni) {
    ...
    // Microsoft - check BEFORE Twitter to avoid t.co matching sharepoint.com etc.
    if (lower_sni.find("microsoft") != std::string::npos ||
        lower_sni.find("windows.com") != std::string::npos ||
        lower_sni.find("sharepoint") != std::string::npos ||
        lower_sni.find("msn.com") != std::string::npos ||
        lower_sni.find(".office.com") != std::string::npos ||
        ...
        lower_sni.find(".mp.microsoft") != std::string::npos ||
        lower_sni.find(".do.dsp.mp") != std::string::npos) {
        return AppType::MICROSOFT;
    }
    
    // Twitter/X - t.co check is now safe since Microsoft caught above
